let canvas = document.getElementById('stage');
  ...
  if(value=="siya"){
    console.log("User entered siya");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/siya.jpg`;
    const hoverUrl = "images/B'day.png";
  ...
  if(value=="bndr"){
    console.log("User entered bndr");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/bandri.jpg`;
    const hoverUrl = "images/bdr.png";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
